...
export const meta: Record<string, ComponentMeta> = {
	'skeleton-swap': { export: 'SkeletonSwap', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'load-more': { export: 'LoadMore', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'streaming-text': { export: 'StreamingText', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'task-steps': { export: 'TaskSteps', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'live-activity': { export: 'LiveActivity', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'collapsible-banner': { export: 'CollapsibleBanner', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'presence-avatars': { export: 'PresenceAvatars', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'modal': { export: 'Modal', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'popover': { export: 'Popover', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'tooltip-group': { export: 'TooltipGroup', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'command-palette': { export: 'CommandPalette', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'drawer': { export: 'Drawer', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'context-menu': { export: 'ContextMenu', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'dropdown': { export: 'Dropdown', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'wizard-steps': { export: 'WizardSteps', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'pagination': { export: 'Pagination', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'tree-view': { export: 'TreeView', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'sticky-header': { export: 'StickyHeader', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'reading-progress': { export: 'ReadingProgress', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'scroll-spy': { export: 'ScrollSpy', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'snap-carousel': { export: 'SnapCarousel', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'hide-on-scroll': { export: 'HideOnScroll', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'sortable-table': { export: 'SortableTable', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'filter-grid': { export: 'FilterGrid', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'value-flash': { export: 'ValueFlash', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'poll-results': { export: 'PollResults', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'slider-detents': { export: 'SliderDetents', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'swipe-deck': { export: 'SwipeDeck', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'reorder-list': { export: 'ReorderList', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'long-press': { export: 'LongPress', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'lightbox': { export: 'Lightbox', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'logo-marquee': { export: 'LogoMarquee', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	'blur-up-image': { export: 'BlurUpImage', props: [], notes: ['Ported from the original interior interaction with stable layout and reduced-motion handling.'] },
	accordion: {
		export: 'Accordion',
		props: [],
